...
public class GreenFruits extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //recycler view
        {
            ...
            listItems.add(new FruitsRecyclerViewModel(R.drawable.avocado,"AVOCADO","3"));
            listItems.add(new FruitsRecyclerViewModel(R.drawable.grape,"GRAPE","1.5"));
            listItems.add(new FruitsRecyclerViewModel(R.drawable.applegreen,"APPLE","2"));
        ...
        findViewById(R.id.back).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(GreenFruits.this,Home.class);
