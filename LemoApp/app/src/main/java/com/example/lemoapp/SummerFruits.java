...
public class SummerFruits extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //recycler view
        {
            ...
            listItems.add(new FruitsRecyclerViewModel(R.drawable.papaya,"PAPAYA","3"));
            listItems.add(new FruitsRecyclerViewModel(R.drawable.pineapple,"PINEAPPLE","1.5"));
            listItems.add(new FruitsRecyclerViewModel(R.drawable.strawberry,"STRAWBERRY","3"));
            listItems.add(new FruitsRecyclerViewModel(R.drawable.watermelon,"WATERMELON","3"));
        ...
        findViewById(R.id.back).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(SummerFruits.this,Home.class);
